                ...
                <nav class="flex-1 overflow-y-auto py-4 px-3">
                    <div class="space-y-1">
                        @if(auth()->user()->isAdmin())
                            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.dashboard') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">dashboard</span>
                                <span>Dashboard</span>
                            </a>
                            <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.users.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">group</span>
                                <span>Users</span>
                            </a>
                            <a href="{{ route('admin.tools.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.tools.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">construction</span>
                                <span>Alat</span>
                            </a>
                            <a href="{{ route('admin.categories.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.categories.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">category</span>
                                <span>Kategori</span>
                            </a>
                            <a href="{{ route('admin.borrowings.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.borrowings.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">swap_horiz</span>
                                <span>Peminjaman</span>
                            </a>
                            <a href="{{ route('admin.returns.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.returns.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">assignment_return</span>
                                <span>Pengembalian</span>
                            </a>
                            <a href="{{ route('admin.reports.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.reports.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">print</span>
                                <span>Laporan</span>
                            </a>
                            <a href="{{ route('admin.activity-logs.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('admin.activity-logs.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">history</span>
                                <span>Log Aktivitas</span>
                            </a>
                        @elseif(auth()->user()->isPetugas())
                            <!-- Same pattern for Petugas links -->
                            <a href="{{ route('petugas.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('petugas.dashboard') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">dashboard</span>
                                <span>Dashboard</span>
                            </a>
                            ...
                            <a href="{{ route('petugas.borrowings.all') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('petugas.borrowings.all') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">swap_horiz</span>
                                <span>Peminjaman Alat</span>
                            </a>
                            <a href="{{ route('petugas.returns.all') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('petugas.returns.all') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">assignment_return</span>
                                <span>Pengembalian Alat</span>
                            </a>
                            <a href="{{ route('petugas.reports.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('petugas.reports.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">print</span>
                                <span>Cetak Laporan</span>
                            </a>
                        @else
                            <!-- Same pattern for Peminjam links -->
                            <a href="{{ route('peminjam.dashboard') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('peminjam.dashboard') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">dashboard</span>
                                <span>Dashboard</span>
                            </a>
                            <a href="{{ route('peminjam.tools.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('peminjam.tools.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">inventory_2</span>
                                <span>Daftar Alat</span>
                            </a>
                            <a href="{{ route('peminjam.borrowings.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('peminjam.borrowings.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">shopping_cart</span>
                                <span>Peminjaman Saya</span>
                            </a>
                            <a href="{{ route('peminjam.history.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded text-sm font-medium transition {{ request()->routeIs('peminjam.history.*') ? 'sidebar-link-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-gray-900 dark:hover:text-white' }}">
                                <span class="material-symbols-outlined text-[20px]">history</span>
                                <span>Riwayat</span>
                            </a>
                        @endif
                ...
                <div class="flex items-center justify-between h-16 px-4 lg:px-6">
                    <div class="flex items-center gap-4">
                        ...
                        <div class="hidden lg:block">
                            <h2 class="text-gray-900 dark:text-white text-sm font-bold tracking-[0.2em] uppercase">@yield('page-title', 'Dashboard')</h2>
