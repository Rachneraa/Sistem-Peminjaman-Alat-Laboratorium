...
<div id="confirmModal"
    ...
    <div
        class="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl max-w-md w-full transform transition-all">
        <!-- Modal Header -->
        ...
        <div class="p-6">
            ...
            <div class="flex justify-end gap-3">
                <button onclick="closeConfirmModal()" id="confirmCancelBtn"
                    class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200 rounded-lg transition font-medium">
                    Batal
                </button>
                <button onclick="confirmAction()" id="confirmOkBtn"
                    class="px-4 py-2 rounded-lg transition font-medium inline-flex items-center gap-2 bg-amber-600 text-white hover:bg-amber-700">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                    </svg>
                    <span id="confirmOkText">Ya, Lanjutkan</span>
                </button>
            </div>
        </div>
    </div>
...
<script>
    ...
    function showConfirmModal(options) {
        ...
        okBtn.className = 'px-4 py-2 rounded-lg transition font-medium inline-flex items-center gap-2';
