...
<div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 mb-6 industrial-border">
    <form method="GET" action="{{ route('petugas.borrowings.all') }}" class="flex flex-wrap gap-4">
        ...
        <div class="flex items-end gap-2 pb-[1px]">
            ...
            <a href="{{ route('petugas.borrowings.all') }}" class="h-[42px] px-4 flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-all font-medium">
