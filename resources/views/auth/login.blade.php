    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-8 relative z-10">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                ...
                <h1 class="text-gray-900 dark:text-white tracking-tight text-3xl font-bold leading-tight">Selamat Datang
                </h1>
                <p class="text-gray-500 dark:text-gray-400 text-sm font-normal mt-2">Login untuk mengakses sistem
                    peminjaman alat</p>
            </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Belum punya akun?
                    <a href="{{ route('register') }}" class="text-primary font-bold hover:underline ml-1">Daftar di
                        sini</a>
                </p>
            </div>
        </div>
