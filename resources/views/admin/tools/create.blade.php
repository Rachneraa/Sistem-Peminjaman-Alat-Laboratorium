            ...
            <form method="POST" action="{{ route('admin.tools.store') }}" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="nama_alat" value="{{ old('nama_alat') }}"
                        ...
                        required placeholder="Masukkan nama alat..." autofocus>
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label
                                class="block text-[10px] text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Stok
                                Rusak</label>
                            <input type="number" name="stok_rusak" value="{{ old('stok_rusak', 0) }}" min="0"
                                class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all"
                                required>
                        </div>
                        <div>
                            <label
                                class="block text-[10px] text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider">Stok
                                Diperbaiki</label>
                            <input type="number" name="stok_perbaikan" value="{{ old('stok_perbaikan', 0) }}" min="0"
                                class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all"
                                required>
                        </div>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="harga_asli" value="{{ old('harga_asli', 0) }}" min="0" step="0.01"
                        class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all"
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="denda_per_hari" value="{{ old('denda_per_hari', 5000) }}" min="0" step="0.01"
                        class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all"
