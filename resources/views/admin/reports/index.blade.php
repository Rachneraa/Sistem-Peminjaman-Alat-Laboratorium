                                ...
                                @forelse($returns as $return)
                                    ...
                                    <tr
                                        ...
                                        <td class="px-4 py-3 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">
                                            {{ $return->user->name }}</td>
                                        <td class="px-4 py-3 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">
                                            {{ $return->tanggal_pinjam->format('d/m/Y') }} - {{ $return->return?->tanggal_kembali?->format('d/m/Y') ?? '-' }}</td>
                                        <td class="px-4 py-3 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">Rp
                                            {{ number_format($return->return?->denda ?? 0, 0, ',', '.') }}</td>
                                        <td class="px-4 py-3 border border-gray-200 dark:border-white/10 text-gray-900 dark:text-white">Rp
                                            {{ number_format($return->return?->denda_kerusakan ?? 0, 0, ',', '.') }}</td>
