...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white uppercase tracking-wider">Detail Peminjaman <span class="text-primary">#<?php echo e($borrowing->id); ?></span></h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-4">
                <div>
                    ...
                    <p class="font-medium text-gray-900 dark:text-white text-lg"><?php echo e($borrowing->user->name); ?></p>
                </div>
                <div>
                    <p class="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest font-bold mb-1">Email</p>
                    <p class="font-medium text-gray-600 dark:text-gray-300 font-mono"><?php echo e($borrowing->user->email); ?></p>
                </div>
                <div>
                ...
                <?php if($borrowing->status == 'disetujui'): ?>
                    ...
                    <div>
                        ...
                        <?php if($estimatedFine['denda'] > 0): ?>
                            <p class="font-bold text-lg text-red-500 dark:text-red-400">Rp <?php echo e(number_format($estimatedFine['denda'], 0, ',', '.')); ?></p>
                            <p class="text-xs text-red-500/70 dark:text-red-400/70 font-bold uppercase tracking-wide"><?php echo e($estimatedFine['terlambat_hari']); ?> hari terlambat</p>
                        <?php else: ?>
        ...
        <div class="space-y-4">
            <?php $__currentLoopData = $borrowing->borrowingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-background-dark/80 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-primary/50 transition-all group">
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-gray-900 dark:text-white text-lg mb-1 group-hover:text-primary transition-colors"><?php echo e($detail->tool->nama_alat); ?></h3>
        ...
        <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 mb-6 industrial-border">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="font-bold text-2xl font-mono <?php echo e($totalDenda > 0 ? 'text-red-500 dark:text-red-400' : 'text-green-500 dark:text-green-400'); ?>">Rp <?php echo e(number_format($totalDenda, 0, ',', '.')); ?></p>
                    ...
                    <div class="mt-2 space-y-1">
                        <?php if($borrowing->return->denda > 0): ?>
                            <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 border-b border-dashed border-gray-300 dark:border-gray-700 pb-1">
                                ...
                                <span class="text-red-500 dark:text-red-400">Rp <?php echo e(number_format($borrowing->return->denda, 0, ',', '.')); ?></span>
                            </div>
                        <?php endif; ?>
                        <?php if(($borrowing->return->denda_kerusakan ?? 0) > 0): ?>
                           <div class="flex justify-between text-xs text-gray-500 dark:text-gray-400 border-b border-dashed border-gray-300 dark:border-gray-700 pb-1">
                                <span>Kerusakan Alat</span>
                                <span class="text-red-500 dark:text-red-400">Rp <?php echo e(number_format($borrowing->return->denda_kerusakan ?? 0, 0, ',', '.')); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
