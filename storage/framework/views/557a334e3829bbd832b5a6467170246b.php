...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h1 class="text-3xl font-bold text-white uppercase tracking-wider">Edit Pengembalian #<?php echo e($return->id); ?></h1>
        ...
        <div class="bg-panel-dark border border-white/5 rounded-xl p-8 industrial-border">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <p class="text-gray-300 font-mono">#<?php echo e($return->borrowing->id); ?></p>
                </div>
            </div>
        </div>
            ...
            <div class="space-y-2">
                <?php $__currentLoopData = $return->borrowing->borrowingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex justify-between items-center p-3 bg-background-dark rounded-lg border border-gray-700/50">
                        <span class="text-sm text-gray-200 font-medium"><?php echo e($detail->tool->nama_alat); ?></span>
    ...
    <div class="bg-panel-dark border border-white/5 rounded-xl p-8 industrial-border">
        <form method="POST" action="<?php echo e(route('admin.returns.update', $return)); ?>" id="returnForm">
            ...
            <div class="mb-6">
                ...
                <input type="date" name="tanggal_kembali" value="<?php echo e(old('tanggal_kembali', $return->tanggal_kembali->format('Y-m-d'))); ?>" class="w-full bg-background-dark border border-gray-700 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" required>
            </div>

            <div class="mb-6">
                <label class="block text-xs font-bold text-gray-400 mb-2 uppercase tracking-widest pl-1">Denda Keterlambatan (Rp)</label>
                <input type="number" name="denda" min="0" step="1000" value="<?php echo e(old('denda', $return->denda)); ?>" class="w-full bg-background-dark border border-gray-700 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" placeholder="0">
            ...
            <div class="mb-6">
                ...
                <input type="number" name="terlambat_hari" min="0" value="<?php echo e(old('terlambat_hari', $return->terlambat_hari)); ?>" class="w-full bg-background-dark border border-gray-700 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" placeholder="0">
            </div>

            <div class="mb-6">
                <label class="block text-xs font-bold text-gray-400 mb-2 uppercase tracking-widest pl-1">Denda Kerusakan (Rp)</label>
                <input type="number" name="denda_kerusakan" min="0" step="1000" value="<?php echo e(old('denda_kerusakan', $return->denda_kerusakan ?? 0)); ?>" class="w-full bg-background-dark border border-gray-700 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" placeholder="0">
            ...
            <div class="mb-8">
                ...
                <textarea name="keterangan" rows="4" class="w-full bg-background-dark border border-gray-700 text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" placeholder="Catatan kondisi alat, kerusakan yang ditemukan, dll..."><?php echo e(old('keterangan', $return->keterangan)); ?></textarea>
            </div>
            ...
            <div class="flex space-x-3 pt-4 border-t border-gray-700/50">
                ...
                <a href="<?php echo e(route('admin.returns.index')); ?>" class="px-6 py-2.5 bg-transparent border border-gray-600 text-gray-300 rounded-lg hover:bg-gray-700 hover:text-white transition-all flex items-center gap-2 font-medium">
                    Batal
                </a>
            </div>
        </form>
