...
<div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 mb-6 industrial-border">
    <form method="GET" action="<?php echo e(route('peminjam.tools.index')); ?>" class="flex flex-wrap gap-4">
        <div class="flex-1 min-w-[200px]">
            <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari alat..." class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-2.5 placeholder-gray-500 transition-all">
        </div>
        <div class="flex-1 min-w-[200px]">
        ...
        <div class="flex items-end gap-2 pb-[1px]">
            ...
            <a href="<?php echo e(route('peminjam.tools.index')); ?>" class="h-[42px] px-4 flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-all font-medium">
        ...
        <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-gray-700 rounded-xl p-4 hover:border-primary/50 transition-all duration-300 aspect-square flex flex-col justify-between group relative overflow-hidden shadow-sm dark:shadow-none" style="aspect-ratio: 1 / 1;">
            <?php if($tool->gambar): ?>
                <div class="w-full h-1/2 mb-3 overflow-hidden rounded-lg relative bg-gray-100 dark:bg-gray-800">
                    <img src="<?php echo e(asset($tool->gambar)); ?>" alt="<?php echo e($tool->nama_alat); ?>" class="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110">
                </div>
            <?php else: ?>
            ...
            <div class="flex-1 flex flex-col justify-between">
                <div>
                    <h3 class="text-lg font-semibold mb-1 text-gray-900 dark:text-white truncate" title="<?php echo e($tool->nama_alat); ?>"><?php echo e($tool->nama_alat); ?></h3>
                    <p class="text-xs text-gray-500 dark:text-gray-400 mb-2 truncate"><?php echo e($tool->category->nama_kategori); ?></p>
                    ...
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-gray-100 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600">
                            ...
                            <span class="text-xs font-bold text-gray-900 dark:text-white ml-3"><?php echo e($tool->stok_tersedia); ?></span>
                        </div>
                ...
                <div class="flex gap-2 mt-auto">
                    <?php if($tool->status == 'tersedia' && $tool->stok_tersedia > 0): ?>
                        <a href="<?php echo e(route('peminjam.borrowings.create', ['tool_id' => $tool->id])); ?>" class="flex-1 px-3 py-2 bg-green-600 hover:bg-green-500 text-white rounded-lg font-medium transition-all inline-flex items-center justify-center gap-1.5 text-xs shadow-lg shadow-green-600/20">
                            <span class="material-symbols-outlined text-[16px]">add</span>
                            Pinjam
                        </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('peminjam.tools.show', $tool)); ?>" class="px-3 py-2 bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-white rounded-lg font-medium transition-all inline-flex items-center justify-center gap-1.5 text-xs <?php echo e($tool->status == 'tersedia' && $tool->stok_tersedia > 0 ? '' : 'flex-1'); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UKKfix\resources\views/peminjam/tools/index.blade.php ENDPATH**/ ?>