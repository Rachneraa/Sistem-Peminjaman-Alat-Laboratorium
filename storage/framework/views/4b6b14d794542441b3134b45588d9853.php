...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 industrial-border relative group overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['active_borrowings']); ?></h3>
    ...
    <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 industrial-border relative group overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['overdue_borrowings']); ?></h3>
            <div class="h-1 w-full bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
    ...
    <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 industrial-border relative group overflow-hidden">
        ...
        <div class="relative z-10">
            ...
            <h3 class="text-3xl font-bold text-gray-900 dark:text-white mb-2"><?php echo e($stats['borrowed_today'] ?? 0); ?></h3>
            <div class="h-1 w-full bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 industrial-border flex flex-col h-full">
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700/50">
            ...
            <a href="<?php echo e(route('petugas.borrowings.index', ['status' => 'menunggu'])); ?>" class="text-xs text-primary hover:text-primary/80 font-bold uppercase tracking-wide flex items-center gap-1 transition-colors">
                Lihat Semua
        ...
        <div class="flex-1 space-y-4 overflow-y-auto max-h-[500px] custom-scrollbar pr-2">
            <?php $__empty_1 = true; $__currentLoopData = $pending_borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 bg-gray-50 dark:bg-background-dark border border-gray-200 dark:border-gray-700/50 rounded-lg group hover:border-primary/30 transition-all">
                        ...
                        <div>
                             <div class="flex items-center gap-2 mb-1">
                                <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wider bg-yellow-500/10 text-yellow-500 border border-yellow-500/20">
                                    #<?php echo e($borrowing->id); ?>

                                </span>
                                <p class="text-sm font-bold text-gray-900 dark:text-white"><?php echo e($borrowing->user->name); ?></p>
                            </div>
                    ...
                    <div class="mb-4 bg-white dark:bg-gray-800/30 p-3 rounded border border-gray-200 dark:border-white/5">
                        ...
                        <div class="space-y-1">
                            <?php $__currentLoopData = $borrowing->borrowingDetails->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex justify-between items-center text-xs">
                                    <span class="text-gray-600 dark:text-gray-300"><?php echo e($detail->tool->nama_alat); ?></span>
                                    <span class="font-mono text-primary"><?php echo e($detail->jumlah); ?>x</span>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if($borrowing->borrowingDetails->count() > 2): ?>
                                <p class="text-[10px] text-gray-500 italic mt-1">+<?php echo e($borrowing->borrowingDetails->count() - 2); ?> alat lainnya</p>
                            <?php endif; ?>
                        </div>
                    </div>
                    
                    <div class="flex gap-2">
                        <form method="POST" action="<?php echo e(route('petugas.borrowings.approve', $borrowing)); ?>" class="flex-1">
                            <?php echo csrf_field(); ?>
                        ...
                        <button onclick="showRejectModal(<?php echo e($borrowing->id); ?>)" class="flex-1 px-3 py-1.5 bg-red-600 hover:bg-red-500 text-white text-xs font-bold rounded uppercase tracking-wider transition-colors flex items-center justify-center gap-1">
                            <span class="material-symbols-outlined text-[16px]">close</span> Reject
                        </button>
                        <a href="<?php echo e(route('petugas.borrowings.show', $borrowing)); ?>" class="px-3 py-1.5 bg-gray-700 hover:bg-gray-600 text-white text-xs font-bold rounded uppercase tracking-wider transition-colors flex items-center justify-center">
    ...
    <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 industrial-border flex flex-col h-full">
        <div class="flex justify-between items-center mb-6 pb-4 border-b border-gray-200 dark:border-gray-700/50">
            ...
            <a href="<?php echo e(route('petugas.returns.index')); ?>" class="text-xs text-primary hover:text-primary/80 font-bold uppercase tracking-wide flex items-center gap-1 transition-colors">
                Lihat Semua
                <span class="material-symbols-outlined text-[16px]">arrow_forward</span>
            </a>
        </div>
        ...
        <div class="flex-1 space-y-4 overflow-y-auto max-h-[500px] custom-scrollbar pr-2">
            <?php $__empty_1 = true; $__currentLoopData = $active_borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="p-4 bg-gray-50 dark:bg-background-dark border border-gray-200 dark:border-gray-700/50 rounded-lg group hover:border-primary/30 transition-all">
                    <div class="flex justify-between items-start mb-3">
                        <div>
                             <div class="flex items-center gap-2 mb-1">
                            ...
                            <div class="grid grid-cols-2 gap-x-4 text-xs text-gray-500 dark:text-gray-400 mt-1">
                                ...
                                <?php if($borrowing->tanggal_selesai): ?>
                                    <span class="flex items-center gap-1 text-red-500 dark:text-red-400">
                                        ...
                                        <?php echo e($borrowing->tanggal_selesai->format('d/m/y')); ?>
                    ...
                    <div class="flex gap-2">
                        <button onclick="showReturnModal(<?php echo e($borrowing->id); ?>)" class="flex-1 px-3 py-1.5 bg-primary hover:bg-primary/90 text-white text-xs font-bold rounded uppercase tracking-wider transition-colors flex items-center justify-center gap-1 shadow-lg shadow-primary/20">
    ...
    <div class="relative bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/10 w-full max-w-md shadow-2xl rounded-xl industrial-border">
        <form id="returnForm" method="POST" class="p-6">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_kembali" value="<?php echo e(date('Y-m-d')); ?>" class="w-full bg-gray-50 dark:bg-background-dark border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block p-3 transition-all" required>
            </div>
...
function showRejectModal(borrowingId) {
    document.getElementById('rejectForm').action = `<?php echo e(url('/petugas/borrowings')); ?>/${borrowingId}/reject`;
...
function showReturnModal(borrowingId) {
    document.getElementById('returnForm').action = `<?php echo e(url('/petugas/borrowings')); ?>/${borrowingId}/return`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UKKfix\resources\views/petugas/dashboard.blade.php ENDPATH**/ ?>