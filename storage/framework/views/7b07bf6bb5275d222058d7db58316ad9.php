    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
            ...
            <div class="flex items-center gap-3 mt-2">
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400 font-mono">#<?php echo e($return->id); ?></span>
            </div>
        </div>
        <div class="flex flex-wrap gap-2">
            <a href="<?php echo e(route('admin.returns.index')); ?>" class="px-5 py-2.5 bg-transparent border border-gray-300 dark:border-gray-600 text-gray-600 dark:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-all flex items-center gap-2 font-medium">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-8 industrial-border">
            ...
            <div class="space-y-4">
                ...
                <div>
                    <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-bold mb-1">Tanggal Kembali</p>
                    <p class="text-gray-900 dark:text-white font-mono flex items-center gap-2">
                        <span class="material-symbols-outlined text-gray-400 dark:text-gray-500 text-sm">calendar_today</span>
                ...
                <?php if($return->keterangan): ?>
                    <div>
                        <p class="text-[10px] text-gray-500 dark:text-gray-400 uppercase tracking-widest font-bold mb-2">Keterangan</p>
                        <div class="bg-gray-50 dark:bg-background-dark p-3 rounded-lg border border-gray-200 dark:border-gray-700/50 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-8 industrial-border">
            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-background-dark rounded border border-gray-200 dark:border-gray-700/50">
                    <div>
                        <p class="text-xs text-gray-600 dark:text-gray-400">Keterlambatan</p>
                        <?php if($return->terlambat_hari > 0): ?>
                            <span class="text-[10px] text-red-500 dark:text-red-400 font-bold uppercase tracking-wider"><?php echo e($return->terlambat_hari); ?> Hari</span>
                        <?php endif; ?>
                    </div>
                    <span class="text-gray-900 dark:text-white font-mono">Rp <?php echo e(number_format($return->denda, 0, ',', '.')); ?></span>
                </div>
                
                <div class="flex justify-between items-center p-3 bg-gray-50 dark:bg-background-dark rounded border border-gray-200 dark:border-gray-700/50">
                    <p class="text-xs text-gray-600 dark:text-gray-400">Kerusakan</p>
                    <span class="text-gray-900 dark:text-white font-mono">Rp <?php echo e(number_format($return->denda_kerusakan ?? 0, 0, ',', '.')); ?></span>
                </div>

                <div class="pt-4 mt-2 border-t border-gray-200 dark:border-gray-700 flex justify-between items-end">
                    <p class="text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-widest">Total Denda</p>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-800">
                    <tr>
                        <th class="px-6 py-4 text-left text-xs font-bold text-gray-500 dark:text-gray-300 uppercase tracking-wider">Nama Alat</th>
                ...
                <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                    <?php $__currentLoopData = $return->borrowing->borrowingDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white font-medium"><?php echo e($detail->tool->nama_alat); ?></td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($detail->tool->category->nama_kategori); ?></td>
