    ...
    <main class="flex-1 flex flex-col items-center justify-center px-6 py-8 relative z-10">
        <div class="w-full max-w-md">
            ...
            <div class="mb-8 text-center">
                ...
                <h1 class="text-gray-900 dark:text-white tracking-tight text-3xl font-bold leading-tight">Selamat Datang</h1>
                <p class="text-gray-500 dark:text-gray-400 text-sm font-normal mt-2">Login untuk mengakses sistem peminjaman alat</p>
            </div>
            ...
            <div class="bg-white dark:bg-panel-dark p-6 rounded-xl shadow-xl border border-gray-200 dark:border-white/5 industrial-border">
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5" x-data="{ loading: false }" @submit="loading = true">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="remember" id="remember" class="rounded border-gray-300 dark:border-input-border bg-white dark:bg-[#1a2e32] text-primary focus:ring-primary focus:ring-offset-white dark:focus:ring-offset-background-dark h-4 w-4">
                        <label for="remember" class="ml-2 text-sm text-gray-600 dark:text-gray-400">Ingat saya</label>
                    </div>

                    <!-- Login Button -->
                    <button type="submit" :disabled="loading" :class="{ 'opacity-75 cursor-not-allowed': loading }" class="w-full bg-primary hover:bg-primary/90 text-white font-bold py-4 rounded-lg shadow-lg shadow-primary/20 transition-all active:scale-[0.98] mt-4 flex items-center justify-center gap-2">
                        <span x-show="!loading" class="flex items-center gap-2">
                            <span class="tracking-[0.1em] uppercase">Login ke Sistem</span>
                        ...
                        <span x-show="loading" class="flex items-center gap-2" style="display: none;">
                            ...
                            <span class="tracking-[0.1em] uppercase">Memproses...</span>
                        </span>
                    </button>
                </form>
            </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Belum punya akun? 
                    <a href="<?php echo e(route('register')); ?>" class="text-primary font-bold hover:underline ml-1">Daftar di sini</a>
                </p>
            </div>
        </div>
    </main>
...
<?php /**PATH D:\UKKfix\resources\views/auth/login.blade.php ENDPATH**/ ?>