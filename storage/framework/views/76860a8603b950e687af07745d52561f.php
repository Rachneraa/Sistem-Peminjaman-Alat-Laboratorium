...
<div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    ...
    <a href="<?php echo e(route('admin.borrowings.create')); ?>" class="w-full md:w-auto justify-center px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-lg transition-all flex items-center gap-2 text-sm font-medium shadow-lg shadow-primary/20">
...
<div class="bg-white dark:bg-panel-dark border border-gray-200 dark:border-white/5 rounded-xl p-6 mb-6 industrial-border">
    <form method="GET" action="<?php echo e(route('admin.borrowings.index')); ?>" class="flex flex-wrap gap-4">
        ...
        <div class="flex items-end gap-2 pb-[1px]">
            ...
            <a href="<?php echo e(route('admin.borrowings.index')); ?>" class="h-[42px] px-4 flex items-center text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-white/5 rounded-lg transition-all font-medium">
            ...
            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                <?php $__empty_1 = true; $__currentLoopData = $borrowings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $borrowing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-white">#<?php echo e($borrowing->id); ?></td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                            <?php if($borrowing->status == 'disetujui'): ?>
                                ...
                                <?php if($estimatedFine['denda'] > 0): ?>
                                    <div class="text-red-400 font-semibold">Rp <?php echo e(number_format($estimatedFine['denda'], 0, ',', '.')); ?></div>
                                    <div class="text-xs text-red-300"><?php echo e($estimatedFine['terlambat_hari']); ?> hari terlambat</div>
                                <?php else: ?>
                                    <span class="text-green-400">Rp 0</span>
                                <?php endif; ?>
                            <?php elseif($borrowing->status == 'dikembalikan' && $borrowing->return): ?>
                                <div class="text-red-400 font-semibold">Rp <?php echo e(number_format($borrowing->return->denda, 0, ',', '.')); ?></div>
                                <?php if($borrowing->return->terlambat_hari > 0): ?>
                                    <div class="text-xs text-gray-400"><?php echo e($borrowing->return->terlambat_hari); ?> hari terlambat</div>
                                <?php endif; ?>
                            <?php else: ?>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex flex-col gap-2">
                                ...
                                <a href="<?php echo e(route('admin.borrowings.edit', $borrowing)); ?>" class="text-primary hover:text-primary/80 inline-flex items-center gap-1">
                                    <span class="material-symbols-outlined text-[18px]">edit</span>
                                    Edit
                                </a>
                                <form method="POST" action="<?php echo e(route('admin.borrowings.destroy', $borrowing)); ?>" class="inline delete-form" data-id="<?php echo e($borrowing->id); ?>">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\UKKfix\resources\views/admin/borrowings/index.blade.php ENDPATH**/ ?>