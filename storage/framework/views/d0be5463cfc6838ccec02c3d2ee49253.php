        ...
        <div class="w-full max-w-md">
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-600 dark:text-gray-400 text-sm">
                    Sudah punya akun? 
                    <a href="<?php echo e(route('login')); ?>" class="text-primary font-bold hover:underline ml-1">Login di sini</a>
                </p>
            </div>
        </div>
    </main>
...
<?php /**PATH D:\UKKfix\resources\views/auth/register.blade.php ENDPATH**/ ?>